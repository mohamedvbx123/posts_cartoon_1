...
BOT_TOKEN = "7717208251:AAGcojhdJhYhC8AegJj9gbB3DfsA-wFWT3I"
CHANNEL_ID = "-1002669234484"  # إشارة -100 مطلوبة للقنوات
LAST_UPDATE_ID = 0
...
def download_image(file_id, folder_path):
    ...
    try:
        ...
        return f"posts_data/cartoon/images/{image_name}"
...
def load_last_update_id():
    ...
    try:
        with open("update_tracking/cartoon_last_id.txt", "r") as f:
...
def save_last_update_id(update_id):
    ...
    with open("update_tracking/cartoon_last_id.txt", "w") as f:
...
def fetch_posts():
    ...
    try:
        ensure_folder_exists("posts_data/cartoon/images")
            ...
            if "channel_post" in update:
                ...
                if chat_id == CHANNEL_ID:
                    ...
                    if (has_text or has_caption) and has_photo:
                        ...
                        image_path = download_image(file_id, "posts_data/cartoon/images")
                        if image_path:
        ...
        if new_updates:
            ...
            existing_posts = []
            try:
                with open("posts_data/cartoon/posts.json", "r", encoding="utf-8") as f:
            ...
            # حفظ في الملف
            with open("posts_data/cartoon/posts.json", "w", encoding="utf-8") as f:
